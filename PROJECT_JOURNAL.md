...
- [x] **Windows Installer:** _(completed 2026-02-18, refined 2026-04-07)_
  ...
  - Build via `python installer/build_windows.py`; output: `dist/installer/DilloSetup-1.0.0.exe`
  - User data stored in `%LOCALAPPDATA%\Dillo` (database, logs); clean uninstall with data removal option
